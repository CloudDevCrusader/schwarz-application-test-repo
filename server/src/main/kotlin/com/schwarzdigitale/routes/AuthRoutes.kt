...
import com.schwarzdigitale.auth.*
import com.schwarzdigitale.domain.models.CustomerCreateRequest
...
fun Route.authRoutes(jwtService: JwtService, customerRepository: CustomerRepository) {
