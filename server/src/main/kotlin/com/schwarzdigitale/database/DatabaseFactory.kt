package com.schwarzdigital.database

import com.schwarzdigital.domain.models.Books
import com.schwarzdigital.domain.models.Categories
import com.schwarzdigital.domain.models.Customers
...
object DatabaseFactory {
    fun init(environment: ApplicationEnvironment) {
        ...
        val database =
            if (embedded) {
                // Use H2 for embedded/testing with PostgreSQL mode
                val db =
                    Database.connect(
                        url = "jdbc:h2:mem:library;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false;MODE=PostgreSQL",
