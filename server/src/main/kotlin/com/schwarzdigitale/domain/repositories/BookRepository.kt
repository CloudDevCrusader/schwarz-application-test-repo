...
class BookRepository {
    ...
    fun create(request: BookCreateRequest): Book = transaction {
        ...
        // Fetch category name
        val categoryName = Categories.selectAll()
    ...
    fun findByCategory(categoryId: Int): List<Book> = transaction {
        (Books innerJoin Categories)
            .selectAll()
    ...
    fun update(id: Int, request: BookUpdateRequest): Boolean = transaction {
