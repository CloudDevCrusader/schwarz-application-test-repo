...
class BookRepositoryTest : DescribeSpec({
    ...
    var testCategoryCounter = 0

    beforeSpec {
        Database.connect("jdbc:h2:mem:test_book;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false;MODE=PostgreSQL", driver = "org.h2.Driver")
        transaction {
    ...
    beforeTest {
        ...
        // Use unique category name for each test to avoid conflicts
        testCategoryCounter++
        testCategory =
            categoryRepository.create(
                CategoryCreateRequest("Test Category $testCategoryCounter", "For testing books"),
            )
    }
    ...
    describe("BookRepository.create") {
        ...
        it("should create a new book") {
            ...
            result.categoryName shouldBe testCategory.name
        }
    ...
    describe("BookRepository.findById") {
        ...
        it("should find book by id") {
            ...
            found.categoryName shouldBe testCategory.name
        }
    ...
    describe("BookRepository.findAll") {
        ...
        it("should include category name for all books") {
            ...
            all.first().categoryName shouldBe testCategory.name
        }
    }
